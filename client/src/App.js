...
class App extends Component {
  ...
  componentDidMount() {
    axiosClient.get('/get').then((response) => {
  ...
  submit = () => {
    axiosClient.post('/insertar', this.state).then(() => {
      alert('Comentario de libro creado')
    })
        ...
        <React.Fragment>
          <Card style={{ width: '18rem' }} className='m-2'>
            <Card.Body>
              ...
              <Card.Text>{val.critica}</Card.Text>
              <input
                name='comentarioUpdate'
                onChange={this.handleStateComentario}
      ...
      <div className='App'>
        ...
        <div className='form'>
          <input
            ...
            onChange={this.handleStateCrear}
          />
          <input
            name='setComentario'
